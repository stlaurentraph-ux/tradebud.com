...
Release health gate runs full marketing post-deploy smoke (live paths + stealth 404 + API checks) when `MARKETING_SMOKE_BASE_URL` is set. Requires marketing middleware stealth fix deployed to production.
