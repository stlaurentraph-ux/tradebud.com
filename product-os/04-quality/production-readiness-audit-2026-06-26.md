...
| H3 | Backend | backend | In-memory per-process rate limiting (`rate-limit.middleware.ts:11`) → N× budget across replicas | Redis/Upstash sliding window; stricter `/v1/public/*` | [x] PR pending |
