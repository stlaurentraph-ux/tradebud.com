...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | `chore/automation-offline-strict` | cursor | Lane 1 slice **1.O.2** — strict guards in CI | `offline-automation-runbook.md` | in_progress | — |
...
- **Automation ops** — **1.O.1** merged (PR #122). **1.O.2** in progress: flip Expo CI to `qa:automation:phase1:strict`.
