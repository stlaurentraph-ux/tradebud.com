...
- **Automation ops** — **Phase 4 through 4.M.1** (marketing axe a11y guard in PR). **Next:** **4.M.2** Lighthouse budgets; human secrets **2.5** / Sentry / optional **EXPO_TOKEN**; Cursor Automations **3.1–3.2**.
