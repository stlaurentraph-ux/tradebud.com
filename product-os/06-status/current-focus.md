...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | — | — | — | — | — | Slice 4.4 marketing Playwright — PR pending; then 4.5 dashboard |
...
- **Automation ops** — **4.4** marketing Playwright in PR (`chore/automation-marketing-playwright-4-4`). **Next:** merge → 4.5 dashboard Playwright; human secrets for 2.5.
