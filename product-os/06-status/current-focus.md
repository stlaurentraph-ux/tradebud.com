...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | — | — | — | — | — | Bundle E 4.1 OpenAPI codegen or human smoke secrets (2.5) |
...
- **Automation ops** — **4.7** in PR (`chore/automation-release-health-gate-4-7`): composite release health gate (CI + smoke + Sentry window). **Next:** merge 4.7; human GitHub secrets for **2.5** / Sentry release health.
