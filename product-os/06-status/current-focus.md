...
- **Automation ops** — **4.2** offline OpenAPI client codegen in PR. **Bundle E** complete. **Next:** merge 4.2; human secrets for **2.5** / Sentry; parked **4.6+** or Cursor Automations **3.1–3.2**.
