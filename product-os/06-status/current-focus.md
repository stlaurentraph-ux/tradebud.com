...
- **Automation ops** — **4.7 + 2.2 live:** release-health secrets + Sentry production alert ([rule 649072](https://tracebud.sentry.io/monitors/alerts/649072/)); marketing/uptime secrets set; gate [#27922953279](https://github.com/stlaurentraph-ux/tradebud.com/actions/runs/27922953279) re-run pending stealth-skip fix. **Next:** marketing prerender stealth fix, or **3.3** weekly health automation.
