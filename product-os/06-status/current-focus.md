...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | `chore/automation-offline-maestro` | cursor | Lane 1 slice **1.O.3** — Maestro CI preflight + macOS workflow | `offline-automation-runbook.md` | in_progress | — |
...
- **Automation ops** — **1.O.1** + **1.O.2** merged (PRs #122, #153). **1.O.3** in progress: Maestro preflight + macOS workflow.
