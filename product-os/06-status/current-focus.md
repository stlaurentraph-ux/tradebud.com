...
- **Automation ops** — **4.3** dashboard proxy contract suite in PR. **Bundle E** otherwise complete (4.4, 4.5, 4.7, 4.1). **Next:** merge 4.3; human secrets for **2.5** / Sentry; parked **4.2+** or Cursor Automations **3.1–3.2**.
