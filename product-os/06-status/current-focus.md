...
- **Automation ops** — **3.3** live (PR #194 runbook, PR #198 first weekly digest merged 2026-06-22). **Lane A:** marketing stealth middleware fix (unpublished IA → 404 at edge; re-enable release-health stealth smoke after Vercel deploy).
