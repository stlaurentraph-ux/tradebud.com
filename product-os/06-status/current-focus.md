...
- **Automation ops** — **4.7 + 2.2 live:** release-health + Sentry production alert ([rule 649072](https://tracebud.sentry.io/monitors/alerts/649072/)); marketing/uptime secrets set; full gate [#27923243984](https://github.com/stlaurentraph-ux/tradebud.com/actions/runs/27923243984) **GO** (all 4 signals). **Next:** marketing prerender stealth fix, or **3.3** weekly health automation.
