...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | — | — | — | — | — | Bundle E 4.5 dashboard Playwright or human smoke secrets (2.5) |
...
- **Automation ops** — **4.4** merged (PR #167): marketing Playwright golden paths in CI. **Next:** 4.5 dashboard Playwright; human GitHub secrets for **2.5**.
