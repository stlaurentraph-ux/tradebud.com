...
- Release QA evidence for ownership/access lane is now populated with CI run URL + artifact proof (`product-os/04-quality/release-qa-evidence.md`); next is reviewer signoff and optional Node 20 deprecation cleanup in CI.
