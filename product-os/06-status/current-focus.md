...
- **Automation ops** — **3.3** weekly health runbook + guard in PR (`chore/automation-weekly-health-3-3`); create Cursor Automation Mon 09:30 UTC after release-health gate.
