...
- Release QA evidence template now includes local non-skipped execution snapshot for ownership/access lane (`product-os/04-quality/release-qa-evidence.md`); next is attaching first CI run URL + artifact link for release-grade proof.
