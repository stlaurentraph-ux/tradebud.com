...
- **Automation ops** — **Phase 4 complete** (4.1–4.10, 4.M.1–4.M.2 on `main`). **Next:** human secrets **2.5** / Sentry / optional **EXPO_TOKEN**; Cursor Automations **3.1–3.2**; Phase 5 when reprioritized.
