...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | `chore/automation-marketing-analytics-guard` | cursor | Lane 1 slice **1.M.3** — marketing analytics guard | `automation-ops-plan.md` | in_progress | — |
...
- **Automation ops** — **3.6** done (PR #159). **1.M.3** in progress: marketing analytics slice guard.
