...
- **Automation ops** — **Phase 4 through 4.10** (Stripe webhook replay guard in PR). **Next:** human secrets for **2.5** / Sentry / optional **EXPO_TOKEN**; parked **4.M.1+** or Cursor Automations **3.1–3.2**.
