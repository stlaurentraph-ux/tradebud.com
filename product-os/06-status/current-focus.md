...
- **Automation ops** — **Phase 4 complete**; **2.M.1–2.M.2** on `main`. **Next:** human secrets **2.5** / Sentry / optional **EXPO_TOKEN**; Cursor Automations **3.1–3.2**; parked Phase 5 when reprioritized.
