...
- **Automation ops** — **Bundle E complete** (4.4, 4.5, 4.7, 4.1 merged). **Next:** human secrets for **2.5** / Sentry release health; parked slices **4.2+** or Cursor Automations **3.1–3.2**.
