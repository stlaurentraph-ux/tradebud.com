...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | `chore/automation-marketing-insights-lint` | cursor | Lane 1 slice **1.M.4** — insights markdown linter | `automation-ops-plan.md` | in_progress | — |
...
- **Automation ops** — **1.M.4** in progress: insights markdown linter (`chore/automation-marketing-insights-lint`).
