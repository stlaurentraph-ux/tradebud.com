...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | — | — | — | — | — | Bundle E Playwright (4.4+) or human smoke secrets (2.5) |
...
- **Automation ops** — **2.7** merged (PR #166): golden staging tenant manifest + CI guard. **Next:** Bundle E Playwright (4.4+); human GitHub secrets for **2.5**; Cursor Automations (3.1–3.2).
