...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | `chore/automation-pr-labeler` | cursor | Lane 1 slice **3.6** — PR path/branch labeler | `automation-ops-plan.md` | in_progress | — |
...
- **Automation ops** — Bundle B **1.2** done (PR #158). **3.6** in progress: PR labeler (`lane:*`, `app:*`, `risk:spatial`).
