...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | `chore/automation-marketing-png-budget` | cursor | Lane 1 slice **1.M.5** — marketing PNG size budget | `automation-ops-plan.md` | in_progress | — |
...
- **Automation ops** — **1.M.5** in progress: marketing PNG size budget guard.
