...
|----|--------|-------|-------|-------------|--------|------------|
| IF-001 | `chore/automation-turbo-remote-cache` | cursor | Lane 1 slice **1.2** — Turbo remote cache in CI | `automation-ops-plan.md` | in_progress | — |
...
- **Automation ops** — Offline **1.O** + **3.O.1** complete. **1.2** in progress: Turbo remote cache wiring in CI (`chore/automation-turbo-remote-cache`).
