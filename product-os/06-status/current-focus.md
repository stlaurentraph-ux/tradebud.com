...
- **Automation ops** — **Phase 4 complete**; **2.5** PR #185 pending merge; **0.H.3** PR-only `main` enabled. **Next:** merge #185; Cursor Automations **3.1–3.2**; Sentry release-health secrets.
