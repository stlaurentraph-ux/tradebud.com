...
- **Automation ops** — **Phase 4 through 4.9** (dashboard mock-vs-real guard in PR). **Next:** human secrets for **2.5** / Sentry / optional **EXPO_TOKEN**; parked **4.10+** or Cursor Automations **3.1–3.2**.
