...
| **1.M.3** | Marketing analytics slice guard (mirror offline `analytics-slice-guard.mjs`) | Event discipline |
| **1.M.4** | Insights markdown linter (frontmatter, slug uniqueness, internal links) | Content CI |
...
| **3.O.1** | Maestro macOS CI on `main` (offline golden path) | offline | in progress — `chore/automation-maestro-main-3o1` |
...
| 4.4 | Playwright: marketing 3-path (home, pricing, waitlist flow w/ mocked API) | marketing |
...
| **3.O.1** | Maestro golden path on `main` | blocking E2E (one flow) | in progress — `chore/automation-maestro-main-3o1` |
