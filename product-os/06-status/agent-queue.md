...
- [ ] **2.4** Marketing post-deploy smoke workflow — `chore/automation-marketing-deploy-smoke` (in progress)
...
- [ ] **2.4** Marketing post-deploy smoke — branch: `chore/automation-marketing-deploy-smoke`
