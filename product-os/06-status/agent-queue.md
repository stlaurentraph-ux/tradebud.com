...
- [ ] **1.5** Dashboard regression guard — `chore/automation-dashboard-regression-guard` (in progress)
...
- [ ] **1.5** Dashboard regression guard — branch: `chore/automation-dashboard-regression-guard`
