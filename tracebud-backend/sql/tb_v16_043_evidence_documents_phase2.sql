-- TB-V16-043: Phase 2 evidence documents, provenance, compliance issues (tenure parse MVP+)
-- Bridges plot evidence sync + plot_tenure_verification to spec §13 shape.
