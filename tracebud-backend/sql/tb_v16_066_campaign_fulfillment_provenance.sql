-- TB-V16-066: ADR-012 P5 campaign fulfillment provenance on recipient decisions.
-- Post phase-1 schema split: request_campaigns + request_campaign_recipient_decisions live in ops.
