...
const COOPERATIVE_STEPS: OnboardingStep[] = [
  ...
  {
    key: 'coop_capture_plot',
    label: 'Map a plot',
    title: 'Capture your first farm plot',
    description: 'Draw or upload the parcel boundary. This is the core unit for deforestation risk checks.',
    ctaLabel: 'Open plots',
    ctaHref: '/plots',
  ...
  },
  {
    ...
    description: 'Exporters will send data requests here. Accept or decline to keep your pipeline moving.',
    ctaLabel: 'Open inbox',
    ctaHref: '/inbox',
