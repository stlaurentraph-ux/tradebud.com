...
export function GuidedTourOverlay() {
  ...
  }, [isActive, currentStepIndex, computePositions]);
  ...
  return createPortal(
    ...
    >
      ...
      <div
        ref={tooltipRef}
        className={cn(
          'absolute z-[9001] w-80 rounded-xl border border-border bg-card shadow-xl',
          ...
          <div className="flex items-center gap-2">
            ...
            {step.ctaHref !== '/' && (
              <Button
                ...
                asChild
              >
                <Link href={step.ctaHref} onClick={nextStep}>
                  {step.ctaLabel}
            ...
            {step.requiresAction && !isCompleted ? (
              ...
              <Button size="sm" className="gap-1 text-xs" onClick={nextStep}>
                Next
