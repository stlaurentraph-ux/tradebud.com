...
const ROLE_CARDS: RoleCard[] = [
  ...
  },
  {
    ...
    highlights: [
      'Send supplier data campaigns',
      'Assemble DDS packages',
      'Track compliance pipeline',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Review inbound data completeness',
      'Prepare DDS filing workflow',
      'Confirm legal role classification',
    ],
