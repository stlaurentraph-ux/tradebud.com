  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="mx-auto max-w-6xl space-y-4">
        ...
        {isLoading ? (
          <AsyncState mode="loading" title={getWorkflowAsyncStateCopy('crm.prospects', 'loading').title} />
        ) : error ? (
          <AsyncState mode="error" title={getWorkflowAsyncStateCopy('crm.prospects', 'error').title} description={error} onRetry={reload} />
        ) : prospects.length === 0 ? (
          <AsyncState mode="empty" title={getWorkflowAsyncStateCopy('crm.prospects', 'empty').title} description={getWorkflowAsyncStateCopy('crm.prospects', 'empty').description} />
        ) : (
