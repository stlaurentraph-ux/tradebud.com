...
import {
  getContentReviewCopy,
  getWorkflowAsyncStateCopy,
} from '@/lib/founder-os-labels';
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="mx-auto max-w-6xl space-y-4">
        ...
        {isLoading ? (
          <AsyncState mode="loading" title={getWorkflowAsyncStateCopy('content.review', 'loading').title} />
        ) : error ? (
          <AsyncState
            mode="error"
            title={getWorkflowAsyncStateCopy('content.review', 'error').title}
            description={error}
            onRetry={() => {
              void reloadCalendar();
              void reloadTasks();
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm">{getContentReviewCopy('needs_review')}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm">{getContentReviewCopy('missed')}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm">{getContentReviewCopy('overdue_tasks')}</CardTitle>
              </CardHeader>
              <CardContent>
