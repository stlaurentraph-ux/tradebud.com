...
const verticals = [
  {
    ...
    description: "Free for farmers. Offline-first polygon mapping creates reusable origin proof. Your compliance passport for any buyer.",
    features: ["Offline GPS mapping", "Photo evidence", "Digital receipts", "Compliance QR"],
    icon: Users,
  ...
  },
  {
    ...
    description: "Member-level field data rolls into cooperative batches. Identity-preserving aggregation, no mass-balance obscuring.",
    features: ["Member management", "Identity-preserving batches", "Exporter handoff", "Scoped roles"],
    icon: Handshake,
    featureIcon: Users,
    color: "#F59E0B",
    href: "#",
  ...
  },
  {
    ...
    hook: "Ship faster. Package proof, not paperwork.",
    description: "Automated Due Diligence Statements, identity-preserving batches, yield checks, and TRACES NT integration.",
    features: ["DDS automation", "Yield checks", "TRACES NT", "Audit-ready exports"],
    icon: Truck,
  ...
  },
  {
    ...
    hook: "Audit-ready in hours, not months.",
    description: "Full upstream visibility with supplier access controls. Receive DDS-ready records and retained evidence trails.",
    features: ["Supply chain visibility", "Liability tracking", "CSRD reporting", "Audit-ready docs"],
    icon: Building2,
    featureIcon: Eye,
  ...
  },
  {
    ...
    hook: "Strengthen public interest data.",
    description: "REST endpoints for national registries. Maintain data sovereignty while enabling compliant trade flows.",
