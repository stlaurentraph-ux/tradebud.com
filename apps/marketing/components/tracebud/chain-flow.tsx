    ...
    <section id="supply-chain" className="py-24 md:py-32 bg-white scroll-mt-20">
      <div className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mt-8 flex items-center justify-center gap-3 text-sm text-gray-600 bg-gray-50 rounded-full px-5 py-2.5 mx-auto w-fit">
            <svg className="w-4 h-4 text-[var(--data-emerald)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
            <span>Farmers own their data. Grant or revoke access anytime.</span>
          </div>
        </motion.div>
