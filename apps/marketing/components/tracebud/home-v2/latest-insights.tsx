      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-12 flex flex-wrap items-end justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex shrink-0 items-center gap-1 rounded-full border border-[var(--warm-stone-dark)] bg-[var(--warm-stone)] px-5 py-2.5 text-sm font-semibold text-[var(--forest-canopy)] transition-colors hover:bg-[var(--warm-stone-dark)]"
          >
            {t('viewAll')} →
          </Link>
        </div>
