...
export default function ImporterDashboardDemoPage() {
  return (
    <main className="min-h-screen bg-stone-50 text-emerald-950">
      <div className="container mx-auto max-w-3xl px-4 py-12 lg:px-8">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight">Importer Dashboard Demo</h1>
        <p className="mt-3 text-sm text-emerald-900/80 sm:text-base">
          Permanent visitor demo for importer-side verification, sourcing transparency,
