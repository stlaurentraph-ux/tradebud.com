...
export function createExploreScreenStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    plotCardShell: { position: 'relative' },
    plotCardStatusCorner: {
      position: 'absolute',
      top: 0,
      right: 0,
      zIndex: 1,
    ...
    plotCardBodyWithCloudIcon: { paddingRight: 28 },
    plotCardBodyWithStatusDot: { paddingRight: 48 },
    plotName: { alignSelf: 'stretch' },
