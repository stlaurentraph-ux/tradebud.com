...
assertIncludes('app/(tabs)/explore.tsx', "getSetting('offlineTilesActivePackId')", 'My Plots reads active offline pack id');
assertNotIncludes('app/(tabs)/explore.tsx', "getSetting('offlineTilesPackId')", 'My Plots must not use stale offline pack key');
