...
export const ANALYTICS_EVENTS = {
  ...
  CAMPAIGN_INVITE_CLAIMED_BY_TOKEN: 'campaign_invite_claimed_by_token',
  FARMER_AUTH_PHONE_OTP_SUCCESS: 'farmer_auth_phone_otp_success',
  FARMER_AUTH_PHONE_OTP_FAILURE: 'farmer_auth_phone_otp_failure',
