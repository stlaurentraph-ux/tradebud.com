...
const strings: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    assessment_tasks_title: 'Assessment Tasks',
    assessment_tasks_assigned: '{n} assigned',
    assessment_tasks_none: 'No pending assessments right now.',
    assessment_open_task: 'Open task',
    assessment_start_form: 'Start form',
    assessment_continue_form: 'Continue form',
    assessment_submit_to_dashboard: 'Submit to dashboard',
    assessment_saving: 'Saving...',
    assessment_questionnaire_label: 'Questionnaire',
    assessment_not_linked: 'not linked',
    assessment_form_title: 'Assessment questionnaire',
    assessment_status_line: 'Request: {requestStatus} · Questionnaire: {questionnaireStatus}',
    assessment_save_draft: 'Save draft',
    assessment_submit_questionnaire: 'Submit questionnaire',
    assessment_submitting: 'Submitting...',
    assessment_saved: 'Draft saved.',
    assessment_questionnaire_submitted: 'Questionnaire submitted. You can now send it to the dashboard.',
    assessment_request_submitted: 'Assessment submitted to dashboard.',
    assessment_load_failed: 'Could not load assessment questionnaire.',
    assessment_save_failed: 'Could not save questionnaire draft.',
    assessment_submit_failed: 'Could not submit assessment.',
    assessment_missing_request: 'Assessment request is missing.',
    assessment_field_placeholder: 'Enter value',
    assessment_array_placeholder: 'Enter JSON array, e.g. [{"product":"NPK"}]',
    plots_stat: 'Plots',
    ...
    sync_queue_preferences_reset: 'Queue retry preferences reset to defaults.',
    sync_queue_no_action_selected: 'Queue retry skipped: no action type selected.',
    sync_queue_smart_pass_retrying: 'Smart sweep pass 1/2: retrying items',
    sync_queue_smart_pass_first: 'Smart sweep pass 2/2: first-attempt items',
    sync_queue_smart_cap_reached: 'Smart sweep cap reached in pass 1/2; skipped pass 2/2.',
    sync_queue_filter_none: 'No queue action selected',
    sync_queue_filter_summary: 'Retry filter: {labels}',
    sync_queue_filter_harvest: 'Harvest',
    sync_queue_filter_photos: 'Photos',
    sync_queue_filter_evidence: 'Evidence',
    sync_queue_attempt_scope_smart: 'Attempt scope: smart sweep (retrying then first-attempt), cap {cap}',
    sync_queue_attempt_scope_retrying: 'Attempt scope: retrying only',
    sync_queue_attempt_scope_first: 'Attempt scope: first attempt only',
    sync_queue_attempt_scope_all: 'Attempt scope: all',
    sync_queue_health_summary: 'Queue health: {pending} pending, {retrying} retrying, highest attempts: {max}',
    sync_queue_latest_error_label: 'Latest queue error',
    sync_queue_next_retry_in: 'Next retry in {seconds}s',
    sync_queue_smart_sweep_label: 'Smart sweep',
    sync_queue_reset_preferences_label: 'Reset preferences',
    sync_queue_attempt_chip_all: 'All attempts',
    sync_queue_attempt_chip_retrying: 'Only retrying',
    sync_queue_attempt_chip_first: 'Only first-attempt',
  ...
  es: {
    ...
    assessment_tasks_title: 'Tareas de evaluación',
    assessment_tasks_assigned: '{n} asignadas',
    assessment_tasks_none: 'No hay evaluaciones pendientes por ahora.',
    assessment_open_task: 'Abrir tarea',
    assessment_start_form: 'Iniciar formulario',
    assessment_continue_form: 'Continuar formulario',
    assessment_submit_to_dashboard: 'Enviar al panel',
    assessment_saving: 'Guardando...',
    assessment_questionnaire_label: 'Cuestionario',
    assessment_not_linked: 'sin vincular',
    assessment_form_title: 'Cuestionario de evaluación',
    assessment_status_line: 'Solicitud: {requestStatus} · Cuestionario: {questionnaireStatus}',
    assessment_save_draft: 'Guardar borrador',
    assessment_submit_questionnaire: 'Enviar cuestionario',
    assessment_submitting: 'Enviando...',
    assessment_saved: 'Borrador guardado.',
    assessment_questionnaire_submitted: 'Cuestionario enviado. Ya puedes enviarlo al panel.',
    assessment_request_submitted: 'Evaluación enviada al panel.',
    assessment_load_failed: 'No se pudo cargar el cuestionario de evaluación.',
    assessment_save_failed: 'No se pudo guardar el borrador del cuestionario.',
    assessment_submit_failed: 'No se pudo enviar la evaluación.',
    assessment_missing_request: 'Falta la solicitud de evaluación.',
    assessment_field_placeholder: 'Introduce un valor',
    assessment_array_placeholder: 'Introduce un arreglo JSON, p. ej. [{"product":"NPK"}]',
    plots_stat: 'Parcelas',
    ...
    sync_queue_preferences_reset: 'Preferencias de reintento restablecidas a valores predeterminados.',
    sync_queue_no_action_selected: 'Reintento de cola omitido: no hay tipo de acción seleccionado.',
    sync_queue_smart_pass_retrying: 'Barrido inteligente paso 1/2: elementos en reintento',
    sync_queue_smart_pass_first: 'Barrido inteligente paso 2/2: elementos de primer intento',
    sync_queue_smart_cap_reached: 'Tope de barrido inteligente alcanzado en el paso 1/2; se omite el paso 2/2.',
    sync_queue_filter_none: 'No hay acción de cola seleccionada',
    sync_queue_filter_summary: 'Filtro de reintento: {labels}',
    sync_queue_filter_harvest: 'Cosecha',
    sync_queue_filter_photos: 'Fotos',
    sync_queue_filter_evidence: 'Evidencia',
    sync_queue_attempt_scope_smart: 'Alcance de intento: barrido inteligente (reintento y luego primer intento), tope {cap}',
    sync_queue_attempt_scope_retrying: 'Alcance de intento: solo reintentos',
    sync_queue_attempt_scope_first: 'Alcance de intento: solo primer intento',
    sync_queue_attempt_scope_all: 'Alcance de intento: todos',
    sync_queue_health_summary: 'Salud de cola: {pending} pendientes, {retrying} en reintento, máximo intentos: {max}',
    sync_queue_latest_error_label: 'Último error de cola',
    sync_queue_next_retry_in: 'Próximo reintento en {seconds}s',
    sync_queue_smart_sweep_label: 'Barrido inteligente',
    sync_queue_reset_preferences_label: 'Restablecer preferencias',
    sync_queue_attempt_chip_all: 'Todos los intentos',
    sync_queue_attempt_chip_retrying: 'Solo reintentos',
    sync_queue_attempt_chip_first: 'Solo primer intento',
