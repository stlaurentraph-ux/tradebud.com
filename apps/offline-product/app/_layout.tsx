...
import { wrapRootLayoutWithOptionalAppMetrics } from '@/features/observability/appMetricsNativeBridge';
...
export default wrapRootLayoutWithOptionalAppMetrics(
  RootLayout,
  shouldUseMaestroCiThinBoot(),
);
