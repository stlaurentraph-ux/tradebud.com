-- Denormalized farmer label on plot for Supabase table browsing (next to farmer_id in exports).
-- Source of truth: crm_contacts.full_name → user_account.name → farmer_profile id prefix.
